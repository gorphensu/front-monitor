...
import MSummaryPageEngineRenderSummary from '~/src/model/summary/page_engine_render_summary'
...
const getSummaryPageEngineRenderList = RouterConfigBuilder.routerConfigBuilder(
...
const getSummaryPageEngineRenderSummary = RouterConfigBuilder.routerConfigBuilder(
  ...
  async (req, res) => {
    ...
    let list = await MSummaryPageEngineRenderSummary.getList(projectId, startAt, endAt, condition)
    list.forEach(data => {
...
export default {
  ...
  ...getSummaryPageEngineRenderList,
  ...getSummaryPageEngineRenderSummary
}